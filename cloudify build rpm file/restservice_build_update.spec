...
cd /var/wheels/%{name}
sudo tar -xvf cloudify-premium-packages-4.1.tar.gz  -C cloudify-premium-packages-4.1&& sudo rm -f cloudify-premium-packages-4.1.tar.gz
...
sudo mv /var/wheels/%{name}/cloudify-premium-packages-4.1/check_runner /opt/manager/env/bin/check_runner
sudo chown root:cfyuser  /opt/manager/env/bin/check_runner  && sudo chmod 755 /opt/manager/env/bin/check_runner
sudo /opt/manager/env/bin/pip install /var/wheels/%{name}/cloudify-premium-packages-4.1/monotonic-1.3-py2.py3-none-any.whl
sudo /opt/manager/env/bin/pip install /var/wheels/%{name}/cloudify-premium-packages-4.1/fasteners-0.13.0-py2.py3-none-any.whl
sudo /opt/manager/env/bin/pip install /var/wheels/%{name}/cloudify-premium-packages-4.1/python_consul-0.6.1-py2-none-any.whl
sudo mv -v /var/wheels/%{name}/cloudify-premium-packages-4.1/cloudify_premium /opt/manager/env/lib/python2.7/site-packages/
sudo mv -v /var/wheels/%{name}/cloudify-premium-packages-4.1/cloudify_premium-4.1.dist-info /opt/manager/env/lib/python2.7/site-packages/  
