...
sudo /tmp/env/bin/pip wheel --wheel-dir=%{buildroot}/var/wheels/%{name} --find-links=%{buildroot}/var/wheels/%{name} http://%{GITHUB_USERNAME}:%{GITHUB_PASSWORD}@git.vnpt-technology.vn/rest/archive/latest/projects/SSDC_NFVCLOUD/repos/cloudify-amqp-influxdb/archive?format=tgz && \
